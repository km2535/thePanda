...
const SearchInput: React.FC<handler> = ({ inputEvent, changeEvent, inputRef }) => {
  ...
  return (
    <div className='flex justify-between h-[80px] align-middle '>
      ...
      <input ref={inputRef} placeholder='상품을 검색하세요' id='keyword' className={'w-full border-b-1 focus-visible:outline-none text-center h-full text-2xl focus:placeholder:invisible'} type="text" onChange={changeEvent as React.ChangeEventHandler<HTMLInputElement>}  onKeyDown={enterDown}/>
