...
public interface KeywordInfo50000002Repository extends JpaRepository<KeywordInfo50000002Entity, String> {
    ...
    @Modifying
    @Transactional
    @Query("INSERT INTO keyword_info_50000002 (id, keyword, monthly_pc_qc_cnt, monthly_mobile_qc_cnt,total_qc_cnt,monthly_ave_pc_cnt,monthly_ave_mobile_cnt,comp_idx,update_date) VALUES (:id, :keyword, :monthly_pc_qc_cnt, :monthly_mobile_qc_cnt, :total_qc_cnt, :monthly_ave_pc_cnt,:monthly_ave_mobile_cnt, :comp_idx, CURDATE())")
