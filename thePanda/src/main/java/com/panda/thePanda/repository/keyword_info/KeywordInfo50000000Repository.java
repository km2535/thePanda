...
@Repository
public interface KeywordInfo50000000Repository extends JpaRepository<KeywordInfo50000000Entity, String> {
    @Query(value = "SELECT * FROM keyword_info_50000000 ORDER BY CAST(total_qc_cnt AS SIGNED) DESC", nativeQuery = true)
    List<KeywordInfo50000000Entity> getKeyword();
