package com.panda.thePanda.util.restclient;
...
public class RestClient {
  ...
  public static synchronized RestClient of(String baseUrl, String apiKey, String secretKey)
  ...
  private <T extends HttpRequest> T withAuthInfo(T request, String path, long customerId, String apiKey,
    ...
    return (T) request
        ...
        .header("X-Signature", SignaturesForNaverAPI.of(timestamp, request.getHttpMethod().name(), path, secretKey));
  }
